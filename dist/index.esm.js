...
function handlePanning(contextInstance, clientX, clientY) {
    var startCoords = contextInstance.startCoords, clientCoords = contextInstance.clientCoords, setup = contextInstance.setup;
    ...
    var paddingValueX = getPaddingValue(contextInstance, sizeX);
    var paddingValueY = getPaddingValue(contextInstance, sizeY);
    if ((clientCoords === null || clientCoords === void 0 ? void 0 : clientCoords.x) != clientX && (clientCoords === null || clientCoords === void 0 ? void 0 : clientCoords.y) != clientY)
